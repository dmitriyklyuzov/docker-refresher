...
```bash
docker tag my-app:1.0 110587347433.dkr.ecr.us-east-1.amazonaws.com/my-app:latest
```
...
```bash
docker push 110587347433.dkr.ecr.us-east-1.amazonaws.com/my-app --all-tags
```
